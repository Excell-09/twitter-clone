...
function Sidebar() {
  ...
  return (
    <>
      <nav className='hidden md:flex flex-col col-span-0 md:col-span-2 items-center px-4 md:items-start'>
        <Image src={logo} alt='logo' className='hidden md:inline object-contain m-3' width={40} height={40} />
